<template>
    <div class="content3 mt-5">
      <div class="header border-b-2 border-gray-200 pb-2 mb-6">
        <p class="text-3xl font-semibold text-gray-800">+Add Doctor</p>
      </div>
      <div class="form-field shadow-lg rounded-lg p-8 bg-white">
        <form @submit.prevent="submitForm">
          <div class="mb-6">
            <label for="name" class="block text-gray-700 font-medium mb-2">Name <sup class=" text-red-700">*</sup></label>
          ...
          <div class="flex space-x-4">
            <div class="w-1/2 mb-6">
              <label for="email" class="block text-gray-700 font-medium mb-2">Email <sup class=" text-red-700">*</sup></label>
              <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
          ...
          <div class="flex space-x-4">
            <div class="w-1/2 mb-6">
              <label for="specialist" class="block text-gray-700 font-medium mb-2">Specialist </label>
              <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
                <i class="fa-solid fa-stethoscope text-gray-400 mr-2"></i>
                <input
                  type="text"
                  id="specialist"
          ...
          <div class="flex space-x-4">
            <div class="w-1/2 mb-6">
              <label for="department" class="block text-gray-700 font-medium mb-2">Select Department <sup class=" text-red-700">*</sup></label>
              <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
  ...
  <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
    ...
    ></textarea>
            ...
            <div class="w-1/2 mb-6">
              <label for="status" class="block text-gray-700 font-medium mb-2">Biography</label>
