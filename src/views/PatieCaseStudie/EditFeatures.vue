<template>
    <div class="content3 mt-5">
      ...
      <div class="form-field shadow-lg rounded-lg p-8 bg-white">
        <form @submit.prevent="submitForm">
          <div class="mb-6">
            <label for="selectPatient" class="block text-gray-700 font-medium mb-2">Select Patient <sup class="text-red-700">*</sup></label>
   ...
   export default {
     ...
     methods: {
       ...
       fetchDataInfo() {
         const doctorInfo = {
           selectPatient: 'Patient A',
           foodAllergy: 'Peanuts',
           heartDisease: 'None',
           hightBloodPressure: 'Yes',
           diabetic: 'No',
           surgery: 'Appendectomy',
           accident: 'Car accident in 2019',
           other: 'None',
           familyMedical: 'Heart disease',
