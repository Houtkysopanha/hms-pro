    ...
    <main>
      ...
      >
        <div class="title-page flex items-center">
          ...
          <div class="title">
            <p class="text-3xl font-bold text-white">Insurances</p>
            <p class="text-sm font-bold text-white">Insurances Features</p>
          </div>
        </div>
      ...
      <div class="content-page">
        ...
        <div class="table-data mt-5 p-3 bg-white rounded-lg shadow-lg">
          ...
          >
            <p class="text-3xl font-medium py-2">Insurances List</p>
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-4 px-4 border-b text-start">
                  <span
                    class="bg-green-200 text-green-600 px-2 py-1 rounded-full"
                    >Active</span
                  >
                </td>
