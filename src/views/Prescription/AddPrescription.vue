<template>
    <div class="content3 mt-5">
      <div class="header border-b-2 border-gray-200 pb-2 mb-6">
        <p class="text-3xl font-bold text-white">Add Prescription</p>
      </div>
      <div class="form-field shadow-lg rounded-lg p-8 bg-white">
        <form @submit.prevent="submitForm">
          <div class="flex space-x-4">
            ...
            <div class="w-1/2 mb-6">
              <label for="PrescriptionDate" class="block text-gray-700 font-medium mb-2">Prescription Date <sup class="text-red-700">*</sup></label>
              <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
                <!-- <i class="fa-solid fa-heartbeat text-gray-400 mr-2"></i> -->
                <input
                  type="date"
                  id="PrescriptionDate"
                  v-model="doctor.PrescriptionDate"
                  class="w-full border-none focus:outline-none"
        ...
        <transition name="fade">
            <div v-if="showCaseStudy" class="case-study-content mb-6">
        ...
        <div class="wight-hight-blood ">
          <div class=" flex space-x-4">
           <div class=" w-1/2 mb-6">
            <label for="Weight" class="block text-gray-700 font-medium mb-2">Weight(kg)  <sup class="text-red-700">*</sup></label>
            <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
              <i class="fa-solid fa-weight-scale text-gray-400 mr-2"></i>
              <input
                type="text"
                id="Weight"
                v-model="caseStudy.wight"
                class="w-full border-none focus:outline-none"
           ...
           <div class=" w-1/2 mb-6">
            <label for="high" class="block text-gray-700 font-medium mb-2">High(feet)  <sup class="text-red-700">*</sup></label>
            <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
              
              <i class="fa-solid fa-ruler text-gray-400 mr-2"></i>
              <input
                type="text"
                id="high"
                v-model="caseStudy.hight"
                class="w-full border-none focus:outline-none"
                placeholder="High(feet)"
                required
              />
            </div>
           ...
           <div class=" w-1/2 mb-6">
            <label for="bloodPressure" class="block text-gray-700 font-medium mb-2">Blood Pressure  <sup class="text-red-700">*</sup></label>
            <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-blue-500">
              <i class="fa-solid fa-droplet text-gray-400 mr-2"></i>
             
              <input
                type="text"
                id="bloodPressure"
                v-model="caseStudy.bloodPressure"
                class="w-full border-none focus:outline-none"
          ...
          <div class="chef-complain">
            <label for="chef-complain" class="block text-gray-700 font-medium mb-2">Chef Complaint <sup class="text-red-700">*</sup></label>
            <textarea class=" border-2 border-gray-300" name="chef-complain" id="chef-complain" placeholder="Chef Complaint" ></textarea>
          </div>
          <div class="table1">
          <table class=" w-full mt-4">
            <thead class=" bg-gray-300 p-4 mb-3">
              <tr>
                <th class="p-3 text-start">Medicine Name</th>
                <th class="text-start" >Medicine Type</th>
                <th class="text-start" >Instruction</th>
                <th class="text-start" >Days</th>
                <th class="text-start" >Add / Remove</th>
              </tr>
              </thead>
              <tbody class="">
                <tr class=" ">
                  <td class="text-start">
                      ...
                      <input class=" border-2 border-gray-200 p-2 mt-3 w-60 focus:outline-none rounded-lg"  type="text" name="" id="" placeholder="Medicine Name">
                  ...
                  <td>
                    <div class="btn-re-add  mt-3">
                      <button class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300">Add</button>
                      <button class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ml-2">Remove</button>
          ...
          <div class="table2 my-10">
          <table class=" w-full mt-4">
            <thead class=" bg-gray-500 p-4 mb-3">
              <tr>
                <th class="p-3 text-start">Diagnosis</th>
                <th class="text-start" >Instruction</th>
                <th class="text-start" >Add / Remove</th>
              </tr>
              </thead>
              <tbody class="">
                <tr class=" ">
                  <td class="text-start">
                      ...
                      <input class=" border-2 border-gray-200 p-2 mt-3 w-96 focus:outline-none rounded-lg"  type="text" name="" id="" placeholder="Diagnosis">
                   
                  </td>
                  <td class="text-start">
                    <input class=" border-2 border-gray-200 p-2 mt-3 w-96 focus:outline-none rounded-lg" type="text" name="" id="" placeholder="Instruction">
                  </td>
           ...
           <div class="note">
            ...
            <textarea class=" border-2 border-gray-300" name="note" id="note" placeholder="Note" ></textarea>
          </div>
