<template>
    ...
    <div class="header-page flex justify-between items-center border-b-2 border-gray-200 py-2">
      <div class="title-page flex items-center">
        ...
        <div class="title">
          <p class=" text-3xl font-bold text-white">Patient Appointment</p>
          <p class=" text-sm font-bold text-white">Patient Appointment Features</p>
        </div>
      </div>
      ...
      <div class="content-page">
        <div class="button-add flex justify-start items-center mt-5">
          <router-link to="/AddPatientAppointments">
        ...
        <div class="table-data mt-5 p-3 bg-white rounded-lg shadow-lg ">
          <div class="header-table flex justify-between items-center border-b-2 border-dashed border-gray-300">
            <p class=" text-3xl font-medium py-2 ">Patient Appointment List</p>
          ...
          <button class=" ml-2 p-3 text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 rounded-lg border-2"> Sort<i class="fa-solid fa-arrow-up-short-wide"></i></button>
            ...
            <tbody>
              <tr v-for="(department, index) in departments" :key="index" class="hover:bg-gray-50">
                ...
                <td class="py-4 px-4 border-b text-start">{{ department.doctorname }}</td>
                <td class="py-4 px-4 border-b text-center">{{ department.patirntname }}</td>
                <td class="py-4 px-4 border-b text-center">{{ department.appointmentdate }}</td>
                <td class="py-4 px-4 border-b text-center">{{ department.appointmenttime }}</td>
                <td class="py-4 px-4 border-b text-center">
                    <router-link to="/PatientAppointInfor">
...
export default {
  ...
  data() {
    return {
      ...
      departments: [
        { id: 1, doctorname: 'Dr Demo Test', patirntname: 'Demo Test1', appointmentdate: '20 Mar 20225', appointmenttime:'10:53-10:40',  },
        { id: 1, doctorname: 'Dr Demo Test', patirntname: 'Demo Test1', appointmentdate: '20 Mar 20225', appointmenttime:'10:53-10:40',  },
        { id: 1, doctorname: 'Dr Demo Test', patirntname: 'Demo Test1', appointmentdate: '20 Mar 20225', appointmenttime:'10:53-10:40',  },
        { id: 1, doctorname: 'Dr Demo Test', patirntname: 'Demo Test1', appointmentdate: '20 Mar 20225', appointmenttime:'10:53-10:40',  },
