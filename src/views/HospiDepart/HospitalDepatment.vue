      ...
      <div class="content-page">
        ...
        <div class="table-data mt-5 p-3 bg-white rounded-lg shadow-lg ">
          <div class="header-table flex justify-between items-center border-b-2 border-dashed border-gray-300">
            <p class=" text-3xl font-medium py-2 ">Departments List</p>
...
export default {
  ...
  data() {
    return {
      ...
      departments: [
        { id: 1, name: 'Cardiology', head: 'Dr. Smith', staff: 20 },
        { id: 2, name: 'Neurology', head: 'Dr. Johnson', staff: 15 },
        { id: 3, name: 'Pediatrics', head: 'Dr. Brown', staff: 25 },
        { id: 4, name: 'Oncology', head: 'Dr. Davis', staff: 10 },
        { id: 5, name: 'Cardiology', head: 'Dr. Smith', staff: 20 },
        { id: 6, name: 'Neurology', head: 'Dr. Johnson', staff: 15 },
        { id: 7, name: 'Pediatrics', head: 'Dr. Brown', staff: 25 },
        { id: 8, name: 'Oncology', head: 'Dr. Davis', staff: 10 },
