    ...
    <main>
      ...
      >
        <div class="title-page flex items-center">
          ...
          <div class="title">
            <p class="text-3xl font-bold text-white">Lab Report</p>
            <p class="text-sm font-bold text-white">Lab Report Features</p>
          </div>
        </div>
      ...
      <div class="content-page">
        ...
        <div class="table-data mt-5 p-3 bg-white rounded-lg shadow-lg">
          ...
          >
            <p class="text-3xl font-medium py-2">Lab Report List</p>
