    ...
    <main>
      ...
      >
        <div class="title-page flex items-center">
          <i class="fa-solid fa-shield-alt text-4xl mr-3 text-white"></i>
          <div class="title">
            <p class="text-3xl font-bold text-white">Lab Report Template</p>
            <p class="text-sm font-bold text-white">Lab Report Template Features</p>
          </div>
        </div>
      ...
      <div class="content-page">
        ...
        <div class="table-data mt-5 p-3 bg-white rounded-lg shadow-lg">
          ...
          >
            <p class="text-3xl font-medium py-2">Lab Report Template List</p>
